...
class MyTest(unittest.TestCase):
    def test_getUrlPath(self):
        str = conf.getUrlPath()
        self.assertEqual(str, '/home/vladymyr/PycharmProjects/CompArcLab1/CompArcLab1/source/urls.xml')

    def test_InfoPath(self):
        str = conf.getInfoPath()
        self.assertEqual(str, '/home/vladymyr/PycharmProjects/CompArcLab1/CompArcLab1/gns/data.txt')
